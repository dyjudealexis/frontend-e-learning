            ...
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 pt-20">
                <div className='grid grid-cols-1 lg:grid-cols-12'>
                    ...
                    <div className='lg:col-start-3 lg:col-span-8 col-span-12 flex flex-col gap-8 items-center text-center'>
                        ...
                        <h1 className='text-midnight_text text-4xl sm:text-5xl font-semibold pt-5 lg:pt-0'>Elevate your engineering career with expert guidance.</h1>
                        <h3 className='text-black/70 text-lg pt-5 lg:pt-0'>Master new skills with our curated programs and experienced mentors.</h3>
                        <div className="relative rounded-full pt-5 lg:pt-0 w-full">
                            <input type="Email address" name="q" className="py-6 lg:py-8 pl-8 pr-20 text-lg w-full text-black rounded-full focus:outline-none shadow-input-shadow" placeholder="Find courses..." autoComplete="off" />
                        ...
                        {/* <div className='flex items-center justify-between pt-10 lg:pt-4'>
                            ...
                            <div className='flex gap-2'>
                                <Image src={`${getImagePrefix()}images/banner/check-circle.svg`} alt="check-image" width={30} height={30} className='smallImage' />
                                <p className='text-sm sm:text-lg font-normal text-black'>Structured modules</p>
                            </div>
                            <div className='flex gap-2'>
                                <Image src={`${getImagePrefix()}images/banner/check-circle.svg`} alt="check-image" width={30} height={30} className='smallImage' />
                                <p className='text-sm sm:text-lg font-normal text-black'>Peer support</p>
                            </div>
                        </div> */}
