    ...
    <footer className="bg-deepSlate py-10">
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        ...
        <div className='mt-10 lg:flex items-center justify-between'>
          <h4 className='text-black/50 text-sm text-center lg:text-start font-normal'>@2025 E-Learning. All Rights Reserved</h4>
          ...
          <h4 className='text-black/50 text-sm text-center lg:text-start font-normal'>Developed by <Link href="https://jude-alexis-dy.site" target="_blank" className="hover:text-primary"> Jude Alexis Dy</Link></h4>
        </div>
      </div>
    </footer>
  )
